...
sys.path.insert(0, os.getenv('FLOW_dir', '/home/yaguo/scripts/amdPython3'))
        ...
        if topHash["INST"][topInst]["refname"] in tileHash:
            ...
            for tileInst in tileHash[tileName]["INST"]:
                ...
                if topHash["INST"][topInst]["oritation"] == "N":
                    topHashFlat["INST"][flatInst]["llx"] = topHash["INST"][topInst]["llx"] + \
                                                           tileHash[tileName]["INST"][tileInst]["llx"]
                    topHashFlat["INST"][flatInst]["lly"] = topHash["INST"][topInst]["lly"] + \
                                                           tileHash[tileName]["INST"][tileInst]["lly"]
                                        ...
                                        if line3.find("related_pin :") > -1:
                                            ...
                                            for line4 in fp:
                                                ...
                                                if line4.find("index_1 ") > -1:
                                                    ...
                                                    libHash[cellName]["ARC"][arcName][
                                                        "inputTrans"] = inputTrans.split()[1:]
                                                elif line4.find("index_2 ") > -1:
                                                    outputLoad = re.sub(r'[();",]', "", line4.rstrip())
                                                    libHash[cellName]["ARC"][arcName][
                                                        "outputLoad"] = outputLoad.split()[1:]
